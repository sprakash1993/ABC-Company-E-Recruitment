<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Home_admin.aspx.cs" Inherits="sample.Home_admin" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
         <ul>
          <li class="active"><a href="Home_admin.aspx">Home</a></li>
